def asset_turnover_ratio(net_sales: float, avg_total_assets: float) -> float:
    """
    Asset Turnover Ratio
    Formula: Net Sales / Average Total Assets
    """
    return net_sales / avg_total_assets
...
def total_asset_turnover(net_sales: float, avg_total_assets: float) -> float:
    """
...
def working_capital_turnover(net_sales: float, avg_working_capital: float) -> float:
    """
    Working Capital Turnover
    Formula: Net Sales / Average Working Capital
    """
    return net_sales / avg_working_capital
...
def equity_turnover(revenue: float, avg_shareholders_equity: float) -> float:
    """
    Equity Turnover
    Formula: Revenue / Average Shareholders' Equity
    """
    return revenue / avg_shareholders_equity
